...
/**
 * @module upload/adapters/athenauploadadapter
 */
 ...
 * minimal {@link module:upload/adapters/athenauploadadapter~AthenaUploadConfig editor configuration}.
 *
 *		ClassicEditor
 ...
 */
export default class AthenaUploadAdapter extends Plugin {
  /**
   * @inheritDoc
   */
  static get requires() {
   ...
   */
  init() {
    const options = this.editor.config.get('athenaUpload');
    ...
    if (!options.uploadUrl) {
      /**
       * The {@link module:upload/adapters/athenauploadadapter~AthenaUploadConfig#uploadUrl `config.athenaUpload.uploadUrl`}
       * configuration required by the {@link module:upload/adapters/athenauploadadapter~AthenaUploadAdapter `AthenaUploadAdapter`}
...
class Adapter {
   ...
   * @param {module:upload/adapters/athenauploadadapter~AthenaUploadConfig} options
   */
  constructor(loader, options) {
     ...
     *
     * @member {module:upload/adapters/athenauploadadapter~AthenaUploadConfig} #options
     */
   ...
   * {@link module:upload/adapters/athenauploadadapter~AthenaUploadConfig#uploadUrl `athenaUpload.uploadUrl`} in the editor's
   * configuration.
   *
   * @private
   */
...
/**
 * The configuration of the {@link module:upload/adapters/athenauploadadapter~AthenaUploadAdapter athena upload adapter}.
 *
 *		ClassicEditor
 ...
 *
 * @interface AthenaUploadConfig
 */

/**
 * The configuration of the {@link module:upload/adapters/athenauploadadapter~AthenaUploadAdapter athena upload adapter}.
 *
 * Read more in {@link module:upload/adapters/athenauploadadapter~AthenaUploadConfig}.
 *
 * @member {module:upload/adapters/athenauploadadapter~AthenaUploadConfig} module:core/editor/editorconfig~EditorConfig#simpleUpload
 */
